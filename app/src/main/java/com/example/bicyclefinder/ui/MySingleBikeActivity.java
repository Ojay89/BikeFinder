...
public class MySingleBikeActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name = findViewById(R.id.singleBikeNameEditText);
        name.setEnabled(false);
        name.setText(originalBike.getName());

        phone = findViewById(R.id.singleBikePhoneEditText);
        phone.setEnabled(false);
        phone.setText(originalBike.getPhone());
        ...
        EditText nameView = findViewById(R.id.singleBikeNameEditText);
        nameView.setText(originalBike.getName());

        EditText phoneView = findViewById(R.id.singleBikePhoneEditText);
        phoneView.setText(originalBike.getPhone());
