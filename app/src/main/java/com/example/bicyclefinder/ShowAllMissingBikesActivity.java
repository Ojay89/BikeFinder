...
public class ShowAllMissingBikesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_all_missing_bikes);
    ...
    private void getAndShowAllMissingBikes(){
        ...
        Call<List<Bike>> getFoundBikesCall = bikeFinderService.getFoundMissingBike("missing");
        messageView.setText("");
    ...
    private void populateRecyclerView(List<Bike> allBikes) {
        ...
        adapter.setOnItemClickListener((view, position, item) -> {
            ...
            Intent intent = new Intent(ShowAllMissingBikesActivity.this, SingleBikeActivity.class);
